...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="tei:body">
        <p>
            <xsl:apply-templates select="//tei:p[@part='I']"/>
            <xsl:apply-templates select="//tei:p[@part='M']"/>
            <xsl:apply-templates select="//tei:p[@part='F']"/>
        </p>
    </xsl:template>
...
<!--        <xsl:for-each-group select="tei:p[not(@part='N')]" group-ending-with="tei:p[@part='F']">
            <p>
                ...
                select="//tei:p[preceding::tei:p[@part='I']][1]"/> 
            </p>
        </xsl:for-each-group> -->
